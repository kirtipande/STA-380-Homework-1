...
***Reading Data:***
```{r}
green_buildings = read.csv("C:/Users/kirti/Downloads/MSBA/Introduction to Predictive modelling/Jame Scott assignment/green_buildings.csv")
```
***Cleaning :***
...
*As evaluated before EEM and VNQ are the aggressive stocks compared to the rest
Hence trying out 2 combinations *
...
social_df = read.csv("C:\\Users\\kirti\\Downloads\\MSBA\\Introduction to Predictive modelling\\Jame Scott assignment\\Class\\social_marketing.csv",header=TRUE,row.names=1)
